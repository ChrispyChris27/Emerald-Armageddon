...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_TATE,
    TRAINER_PIC_FRONT_LIZA,
    ...
    TRAINER_PIC_FRONT_EMERALD_LK,
    TRAINER_PIC_FRONT_RUBY_LK,
    TRAINER_PIC_FRONT_SAPPHIRE_LK,
...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_LOREKEEPER_RUBY,
    TRAINER_CLASS_LOREKEEPER_SAPPHIRE,
    TRAINER_CLASS_LOREKEEPER_EMERALD,
