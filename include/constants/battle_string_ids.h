...
enum StringID
{
    ...
    STRINGID_STRONGWINDCONTINUES,
    STRINGID_STRONGWINDSTARTS, 
    ...
    STRINGID_TERASTALIZATION,
    STRINGID_ERRATIC_WEATHER_START,
    STRINGID_ERRATIC_WEATHER_CHANGE,
    STRINGID_WIND_GUSTS_BLOWN_AWAY,
