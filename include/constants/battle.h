...
#define BATTLE_TYPE_NECROZMA           (1 << 14)
...
#define BATTLE_TYPE_ROGUE              (1 << 28)
#define BATTLE_TYPE_ROGUE_GMAX         (1 << 29)
#define BATTLE_TYPE_ROGUE_TERA         (1 << 30)
