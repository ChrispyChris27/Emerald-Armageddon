...
// Other battle flags
#define B_FLAG_INVERSE_BATTLE       FLAG_INVERSE_BATTLES     // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
...
#define B_FLAG_NO_CATCHING          FLAG_NO_CATCH_WILD  // If this flag is set, the ability to catch wild Pokémon is disabled.
#define B_FLAG_NO_RUNNING           FLAG_NO_RUN_WILD     // If this flag is set, the ability to escape from wild battles is disabled. Also makes Roar/Whirlwind and Teleport (under Gen8) fail.
