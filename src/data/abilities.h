const struct AbilityInfo gAbilitiesInfo[ABILITIES_COUNT] =
{
    ...
    {
        .name = _("Run Away"),
        .description = COMPOUND_STRING("Ensures escape."),
        .aiRating = 0,
    },
    ...
    {
        .name = _("Leaf Guard"),
        .description = COMPOUND_STRING("Blocks crits and status."),
        .aiRating = 2,
        .breakable = TRUE,
    },
    ...
    [ABILITY_AS_ONE_MEOWSTIC] =
    {
        .name = _("As One"),
        .description = COMPOUND_STRING("Prankster and Competitive."),
        .aiRating = 10,
        .cantBeCopied = TRUE,
        .cantBeSwapped = TRUE,
        .cantBeTraced = TRUE,
