...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_PYROAR}),
    },
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .abilities = { ABILITY_FLOWER_VEIL, ABILITY_HEALER, ABILITY_SYMBIOSIS },  \
        .bodyColor = BODY_COLOR_WHITE,                                          \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_MOLD_BREAKER, ABILITY_NO_GUARD },
        .bodyColor = BODY_COLOR_WHITE,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx, _overworldAnim)   \
    ...
    [SPECIES_MEOWSTIC_M_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_AS_ONE_MEOWSTIC, ABILITY_AS_ONE_MEOWSTIC, ABILITY_AS_ONE_MEOWSTIC },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Meowstic"),
    #if P_MODIFIED_MEGA_CRIES
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_SHIELD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_STANCE_CHANGE, ABILITY_STANCE_CHANGE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_INKAY] =
    {
        ...
        .abilities = { ABILITY_SUCTION_CUPS, ABILITY_INFILTRATOR, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Inkay"),
        .cryId = CRY_INKAY,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .abilities = { ABILITY_POISON_POINT, ABILITY_REGENERATOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_DRAGALGE}),
    },
    ...
    [SPECIES_DRAGALGE_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_REGENERATOR, ABILITY_REGENERATOR, ABILITY_ADAPTABILITY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Dragalge"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_CLAUNCHER] =
    {
        ...
        .abilities = { ABILITY_MEGA_LAUNCHER, ABILITY_SHELL_ARMOR, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    [SPECIES_DEDENNE] =
    {
        ...
        .abilities = { ABILITY_CHEEK_POUCH, ABILITY_ILLUMINATE, ABILITY_PLUS },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_GOOEY, ABILITY_SAP_SIPPER },
    ...
    [SPECIES_SLIGGOO_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_GOOEY, ABILITY_SAP_SIPPER },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_PRANKSTER, ABILITY_HARVEST, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_VOLCANION] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_NONE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BROWN,
