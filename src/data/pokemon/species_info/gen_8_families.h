...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_SILICOBRA] =
    {
        ...
        .abilities = { ABILITY_SAND_FORCE, ABILITY_SHED_SKIN, ABILITY_SAND_PIT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HATENNA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_HATTREM}),
    },
    ...
    [SPECIES_IMPIDIMP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_MORGREM}),
    },
