...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_SHELL_ARMOR, ABILITY_THICK_FAT },
    ...
    [SPECIES_STARAPTOR_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_RECKLESS, ABILITY_RECKLESS, ABILITY_CONTRARY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Staraptor"),
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHARPNESS, ABILITY_TECHNICIAN, ABILITY_TINTED_LENS },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_SHINX] =
    {
        ...
        .abilities = { ABILITY_STATIC, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Shinx"),
        .cryId = CRY_SHINX,
    ...
    [SPECIES_BURMY_PLANT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_WORMADAM_PLANT, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 15, SPECIES_MOTHIM_PLANT, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_BURMY_SANDY] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_WORMADAM_SANDY, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 15, SPECIES_MOTHIM_SANDY, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_BURMY_TRASH] =
    {
        ...
        .formSpeciesIdTable = sBurmyFormSpeciesIdTable,
        .formChangeTable = sBurmyFormChangeTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 15, SPECIES_WORMADAM_TRASH, CONDITIONS({IF_GENDER, MON_FEMALE})},
                                {EVO_LEVEL, 15, SPECIES_MOTHIM_TRASH, CONDITIONS({IF_GENDER, MON_MALE})}),
    },
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_NONE, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SAND_RUSH, ABILITY_NONE, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 20, SPECIES_VESPIQUEN}),
    },
    ...
    [SPECIES_BUIZEL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_FLOATZEL}),
    },
    ...
    [SPECIES_DRIFLOON] =
    {
        ...
        .abilities = { ABILITY_UNBURDEN, ABILITY_FLARE_BOOST, ABILITY_WIND_RIDER },
        .bodyColor = BODY_COLOR_PURPLE,
        .noFlip = TRUE,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_SOUNDPROOF, ABILITY_BIG_PECKS },
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 48, SPECIES_LUCARIO}),
    },
    ...
    [SPECIES_HIPPOPOTAS] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_HIPPOWDON}),
    },
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { ABILITY_HYDRATION, ABILITY_POISON_TOUCH, ABILITY_DRY_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CARNIVINE] =
    {
        ...
        .abilities = { ABILITY_STRONG_JAW, ABILITY_LEAF_GUARD, ABILITY_LEVITATE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SOUNDPROOF, ABILITY_LEAF_GUARD, ABILITY_SNOW_WARNING },
        .bodyColor = BODY_COLOR_WHITE,
...
#define ROTOM_FAMILY_TYPES { TYPE_ELECTRIC, TYPE_GHOST }
    ...
    [SPECIES_HEATRAN_MEGA] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_MAGMA_ARMOR, ABILITY_MAGMA_ARMOR, ABILITY_FLAME_BODY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Heatran"),
    #if P_MODIFIED_MEGA_CRIES
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_SLOW_START, ABILITY_NONE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_WHITE,
