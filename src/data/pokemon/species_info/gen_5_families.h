...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_PATRAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ILLUMINATE, ABILITY_ANALYTIC, ABILITY_RUN_AWAY },
    ...
    [SPECIES_LILLIPUP] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_VITAL_SPIRIT, ABILITY_CUTE_CHARM, ABILITY_RUN_AWAY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_TELEPATHY, ABILITY_HEALER },
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STATIC, ABILITY_MOTOR_DRIVE, ABILITY_SAP_SIPPER },
    ...
    [SPECIES_ROGGENROLA] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_BOLDORE}),
    },
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 24, SPECIES_PALPITOAD}),
    },
    ...
    [SPECIES_SWADLOON] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 28, SPECIES_LEAVANNY}),
    },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_PETILIL] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_OWN_TEMPO },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_LILLIGANT_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_LEAF_GUARD, ABILITY_HUSTLE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Lilligant"),
        .cryId = CRY_LILLIGANT,
    ...
    [SPECIES_SANDILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SAND_FORCE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_DARUMAKA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HUSTLE, ABILITY_FLAME_BODY, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_RED,
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_FIRE_STONE, SPECIES_DARMANITAN_STANDARD}),
    },
    ...
    [SPECIES_DARMANITAN_STANDARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ZEN_MODE, ABILITY_FLAME_BODY, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_DARUMAKA_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_HUSTLE, ABILITY_ICE_BODY, ABILITY_INNER_FOCUS },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Darumaka"),
        .cryId = CRY_DARUMAKA,
        .natDexNum = NATIONAL_DEX_DARUMAKA,
    ...
    [SPECIES_DARMANITAN_GALAR_STANDARD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ZEN_MODE, ABILITY_ICE_BODY, ABILITY_GORILLA_TACTICS },
        .bodyColor = BODY_COLOR_WHITE,
        .speciesName = _("Darmanitan"),
        .cryId = CRY_DARMANITAN,
        .natDexNum = NATIONAL_DEX_DARMANITAN,
    ...
    [SPECIES_DARMANITAN_GALAR_ZEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ZEN_MODE, ABILITY_NONE, ABILITY_GORILLA_TACTICS },
        .bodyColor = BODY_COLOR_WHITE,
        .noFlip = TRUE,
        .speciesName = _("Darmanitan"),
        .cryId = CRY_DARMANITAN,
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_STORM_DRAIN, ABILITY_CHLOROPHYLL, ABILITY_SOLAR_POWER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 25, SPECIES_CRUSTLE}),
    },
    ...
    [SPECIES_SIGILYPH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_MAGIC_GUARD, ABILITY_TINTED_LENS, ABILITY_WONDER_SKIN },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_ARCHEN] =
    {
        ...
        .abilities = { ABILITY_DEFEATIST, ABILITY_HUSTLE, ABILITY_ROCK_HEAD },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_GOTHITA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
    #if P_UPDATED_ABILITIES >= GEN_6
        .abilities = { ABILITY_COMPETITIVE, ABILITY_SHADOW_TAG, ABILITY_FRISK },
    #else
    ...
    [SPECIES_VANILLITE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_ICE_BODY, ABILITY_FILTER, ABILITY_SNOW_CLOAK },
    #else
    ...
    [SPECIES_VANILLUXE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
    #if P_UPDATED_ABILITIES >= GEN_7
        .abilities = { ABILITY_ICE_BODY, ABILITY_FILTER, ABILITY_SNOW_WARNING },
    #else
        .abilities = { ABILITY_ICE_BODY, ABILITY_NONE, ABILITY_WEAK_ARMOR },
    #endif
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_ESCAVALIER] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, ABILITY_SHELL_ARMOR, ABILITY_SHARPNESS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_KLINK] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MINERAL),
        .abilities = { ABILITY_CLEAR_BODY, ABILITY_FILTER, ABILITY_MINUS },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Klink"),
        .cryId = CRY_KLINK,
    ...
    [SPECIES_TYNAMO] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_LEVITATE, ABILITY_SURGE_SURFER, ABILITY_NONE },
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_AXEW] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_UNNERVE, ABILITY_RIVALRY },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Axew"),
        .cryId = CRY_AXEW,
    ...
    [SPECIES_ACCELGOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_TINTED_LENS, ABILITY_SWARM, ABILITY_UNBURDEN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_STUNFISK_GALAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_MIMICRY, ABILITY_STRONG_JAW, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
        .speciesName = _("Stunfisk"),
        .cryId = CRY_STUNFISK,
    ...
    [SPECIES_KINGAMBIT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_HUMAN_LIKE),
        .abilities = { ABILITY_SUPREME_OVERLORD, ABILITY_INNER_FOCUS, ABILITY_PRESSURE },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_BOUFFALANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_RECKLESS, ABILITY_ROCK_HEAD, ABILITY_SOUNDPROOF },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_HEATMOR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_GLUTTONY, ABILITY_WHITE_SMOKE, ABILITY_FLASH_FIRE },
        .bodyColor = BODY_COLOR_RED,
...
#define GENESECT_SPECIES_INFO(form)                                                 \
    {                                                                               \
        ...
        .growthRate = GROWTH_SLOW,                                                  \
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),                  \
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_NONE, ABILITY_DOWNLOAD },      \
        .bodyColor = BODY_COLOR_PURPLE,                                             \
