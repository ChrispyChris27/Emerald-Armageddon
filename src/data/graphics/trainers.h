...
const struct TrainerSprite gTrainerSprites[] =
{
    ...
    TRAINER_SPRITE(TRAINER_PIC_GIOVANNI, gTrainerFrontPic_RocketLeaderGiovanni, gTrainerPalette_RocketLeaderGiovanni),
    TRAINER_SPRITE(TRAINER_PIC_COURTNEY, gTrainerFrontPic_Courtney, gTrainerPalette_Courtney),
    TRAINER_SPRITE(TRAINER_PIC_ARCHER, gTrainerFrontPic_RocketAdminM, gTrainerPalette_RocketAdminM),
    TRAINER_SPRITE(TRAINER_PIC_ARIANA, gTrainerFrontPic_RocketAdminF, gTrainerPalette_RocketAdminF),
};
