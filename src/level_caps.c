...
u32 GetCurrentLevelCap(void)
{
    static const u32 sLevelCapFlagMap[][2] =
    {
        ...
        {FLAG_RIVAL_110, 36},
        {FLAG_BADGE03_GET, 38},
        {FLAG_FALLARBOR_BOSS, 41},
        {FLAG_CHIMNEY_MAXIE, 46},
        {FLAG_BADGE04_GET, 49},
        {FLAG_GIOVANNI_FALLS, 52},
        {FLAG_BADGE01_GET, 54},
        {FLAG_BADGE02_GET, 57},
        {FLAG_SHELLY_WINSTITUTE, 61},
        {FLAG_RIVAL_BRIDGE, 62},
        {FLAG_BADGE06_GET, 64},
        {FLAG_RIVAL_LILYCOVE, 68},
        {FLAG_ARCHIE_PYRE, 71},
        {FLAG_HIDEOUT_MAXIE, 76},
        {FLAG_HIDEOUT_MATT, 78},
        {FLAG_BADGE07_GET, 80},
        {FLAG_ROCKET_TAG, 82},
