...
static const enum Item sPrizeListSludgeBomb[]  = {ITEM_TM_GUNK_SHOT,   ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
...
static const enum Item sPrizeListSunnyDay[]    = {ITEM_TM_LAVA_PLUME,     ITEM_ETHER, ITEM_MAX_POTION, ITEM_REVIVE, ITEM_FLUFFY_TAIL, ITEM_GREAT_BALL};
