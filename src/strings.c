...
const u8 gTextNormalLocatinator[] =_("The LOCATINATOR senses nothing\n unusual here.");
const u8 gTextRoamerLocatinator[] =_("The LOCATINATOR is flashing brightly!\nSomething rare must be nearby!");
