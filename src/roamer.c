...
void ReleaseRoamers(void)
{
    ...
    TryAddRoamer(SPECIES_ARTICUNO_GALARIAN, 80, FLEES, INSTANT_RESPAWN);
    TryAddRoamer(SPECIES_ZAPDOS, 80, FLEES, INSTANT_RESPAWN);
    TryAddRoamer(SPECIES_ZAPDOS_GALARIAN, 80, FLEES, INSTANT_RESPAWN);
    TryAddRoamer(SPECIES_MOLTRES, 80, FLEES, INSTANT_RESPAWN);
    TryAddRoamer(SPECIES_MOLTRES_GALARIAN, 80, FLEES, INSTANT_RESPAWN);
