...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
    ...
    [MAPSEC_PETALBURG_SANCTUARY - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_METEOR_CASTLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROCKET_HIDEOUT2 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DRAGONS_DEN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    ...
    [MAPSEC_ULTRA_SPACE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_DISTORTION
};
